...
* [fa_pg_ora_snap_remote](./fa_pg_ora_snap_rac) - Python script to snapshot and clone an Oracle database to/from remote servers including RAC clustered databases.
