# Linux shell scripts for cloning Oracle  

These are the original bash scripts developed for cloning an Oracle database on a Pure Flash Array.
These require the purevol executable to be installed.
